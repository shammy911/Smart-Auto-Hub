...
interface ColomboModalProps {
  isOpen: boolean;
  onOpenChange: (open: boolean) => void;
}

export default function ColomboModal({
  isOpen,
  onOpenChange,
}: ColomboModalProps) {
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 py-4">
          ...
          <div className="space-y-4">
            <div className="aspect-video relative rounded-lg overflow-hidden bg-secondary border border-border shadow-md">
              <img
                src="/premium-car-showroom-interior-with-luxury-vehicles.jpg"
                ...
                <div className="space-y-3">
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-foreground">No. 88, Union Place, Colombo 02</p>
                        </div>
                    </div>
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-foreground">Mr. Sarah De Silva</p>
                        </div>
                    </div>
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-foreground">011-2334455</p>
                        </div>
                    </div>
                </div>
            </div>
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-2 gap-4">
               ...
               <div className="p-4 bg-orange-500/10 border border-orange-500/20 rounded-lg flex flex-col items-center justify-center text-center">
                  ...
                  <p className="text-3xl font-bold text-orange-700 dark:text-orange-400">16</p>
               ...
               <div className="p-4 bg-blue-500/10 border border-blue-500/20 rounded-lg flex flex-col items-center justify-center text-center">
                  ...
                  <p className="text-3xl font-bold text-blue-700 dark:text-blue-400">9</p>
