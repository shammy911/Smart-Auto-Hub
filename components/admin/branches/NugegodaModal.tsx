...
interface NugegodaModalProps {
  isOpen: boolean;
  onOpenChange: (open: boolean) => void;
}

export default function NugegodaModal({
  isOpen,
  onOpenChange,
}: NugegodaModalProps) {
  return (
                ...
                <div className="space-y-3">
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-foreground">No. 125, High Level Road, Nugegoda</p>
                        </div>
                    </div>
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-foreground">Mr. Kamal Perera</p>
                        </div>
                    </div>
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-foreground">011-2826543</p>
                        </div>
                    </div>
                </div>
            </div>
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-2 gap-4">
               ...
               <div className="p-4 bg-green-500/10 border border-green-500/20 rounded-lg flex flex-col items-center justify-center text-center">
                  ...
                  <p className="text-3xl font-bold text-green-700 dark:text-green-400">30</p>
               ...
               <div className="p-4 bg-orange-500/10 border border-orange-500/20 rounded-lg flex flex-col items-center justify-center text-center">
                  ...
                  <p className="text-3xl font-bold text-orange-700 dark:text-orange-400">10</p>
               ...
               <div className="p-4 bg-blue-500/10 border border-blue-500/20 rounded-lg flex flex-col items-center justify-center text-center">
                  ...
                  <p className="text-3xl font-bold text-blue-700 dark:text-blue-400">5</p>
            ...
            <div className="bg-muted/30 p-4 rounded-lg border border-border">
                ...
                <ul className="space-y-2">
                    ...
                    <li className="flex items-center justify-between text-sm p-2 bg-background rounded border border-border/50">
                        <span>Honda Vezel 2016</span>
                        <span className="text-xs bg-orange-100 text-orange-700 px-2 py-0.5 rounded-full dark:bg-orange-900/30 dark:text-orange-400">Shipped</span>
                    </li>
                     <li className="flex items-center justify-between text-sm p-2 bg-background rounded border border-border/50">
                        <span>Suzuki Wagon R 2019</span>
                        <span className="text-xs bg-green-100 text-green-700 px-2 py-0.5 rounded-full dark:bg-green-900/30 dark:text-green-400">Available</span>
                    </li>
                </ul>
            </div>
