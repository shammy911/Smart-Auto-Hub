...
export default function RegisterPage() {
  ...
  return (
    <div className="flex min-h-screen w-full overflow-hidden bg-muted/20">
      {/* SIDE A: VISUAL - COPIED FROM LOGIN & UPDATED IMAGE */}
      <div className="hidden lg:flex lg:w-1/2 relative bg-black overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-end h-full p-12 text-white">
          <h2 className="text-5xl font-extrabold mb-6 tracking-tight drop-shadow-lg bg-gradient-to-br from-white via-gray-100 to-gray-300 bg-clip-text text-transparent">
            <span className="italic">Smart</span> Auto Hub
          </h2>
          <p className="text-xl text-gray-100 max-w-lg leading-relaxed font-light tracking-wide drop-shadow-md">
             Experience the future of automotive excellence. Join us today.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-4 lg:p-8 relative">
        <div className="w-full max-w-[450px]">
          ...
          <div className="bg-white w-full shadow-xl rounded-2xl p-8 space-y-6 border">
            <h1 className="text-3xl font-bold text-center mb-6">Create Account</h1>
